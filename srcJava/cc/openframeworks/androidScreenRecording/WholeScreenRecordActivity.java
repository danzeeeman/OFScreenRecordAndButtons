...
public class WholeScreenRecordActivity extends cc.openframeworks.OFActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button toggleRecording = findViewById(R.id.record_button);
        ...
        toggleRecording.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (v.getId() == R.id.record_button) {
                    if (muxerStarted) {
                        stopRecording();
                        ((Button) findViewById(R.id.record_button)).setText(R.string.toggleRecordingOn);
                    } else {
